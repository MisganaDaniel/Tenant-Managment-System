            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0">End Date Contracts</h4>
                  <p class="card-category"> List of End Date Contracts</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    if(empty($_POST['category'])){
                        $sql_contracts = "SELECT * FROM `contract` WHERE end_date>= NOW() - end_date 
