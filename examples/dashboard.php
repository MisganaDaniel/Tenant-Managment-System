        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">List of Stall Spaces Reports </p>
                  <h3 class="card-title">49/50
                    <small>All Stall Spaces have a costumer </small>
                  </h3>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h3 class="card-title">34,245 brr</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  <div class="card-icon">
                    <i class="material-icons">Renewal Requests</i>
                  </div>
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">local_offer</i>Fixed Requests 2 
                  </div>
                </div>
              </div>
            </div>
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Stall Spaces </h4>
                  <p class="card-category">List of Stall Spaces Reports</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> From 2 days ago
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Completed Contrats</h4>
                  <p class="card-category">End date of Contrats</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> End of Date 1 days ago
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title">Applicant Stats</h4>
                  <p class="card-category">New Applicant on 22th Dec, 2020</p>
                </div>
