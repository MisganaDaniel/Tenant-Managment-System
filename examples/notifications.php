            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Renewal Requests</h4>
                  <p class="card-category">new Renewal Requests lists
                    ...
                    if(mysqli_num_rows($result_renewal) > 0 ){
                        while($row_renewal = mysqli_fetch_assoc($result_renewal)){
                            echo "<tr align='center'>";
                                ...
                                if($remark == 'Approved'){
                                    echo "<td>";
                                        echo "<a href='notificationsh.php?renewal_id=$renewal_id' class='btn btn-primary btn-sm' style='font-size: 11px; margin: 1px;'>View</a>";
